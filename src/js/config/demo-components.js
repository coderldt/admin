export default [
  {
    path: '/employe/list',
    name: 'EmployeList',
    component: (resolve) => require(['view/employe/list'], resolve),
    meta: { title: '员工管理' }
  },
  {
    path: '/goods/list',
    name: 'goodslist',
    component: (resolve) => require(['view/goods/list'], resolve),
    meta: { title: '商品列表' }
  },
  {
    path: '/goods/edit',
    name: 'goodsedit',
    component: (resolve) => require(['view/goods/edit'], resolve),
    meta: { title: '商品添加' }
  },
  {
    path: '/specie/list',
    name: 'specie',
    component: (resolve) => require(['view/specie/index'], resolve),
    meta: { title: '分类管理' }
  },
  {
  path: '/form',
